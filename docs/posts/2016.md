...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-31-far-friends&postLocation=)</code> `🚀 OpenMW` `nofilter` `night`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-24-double-winged-attack&postLocation=)</code> `🚀 OpenMW` `nofilter`
...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-20-a-boxy-nightstand&postLocation=)</code> `🚀 OpenMW` `nofilter`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-15-cloud-crowns-of-foyada-mamaea&postLocation=)</code> `🚀 OpenMW` `nofilter` `night`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-03-st-delyn-vs-st-olms&postLocation=)</code> `🚀 OpenMW` `nofilter`
