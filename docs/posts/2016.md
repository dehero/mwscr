...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-24-double-winged-attack&postLocation=)</code> `🚀 OpenMW`
...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-20-a-boxy-nightstand&postLocation=)</code> `🚀 OpenMW`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-15-cloud-crowns-of-foyada-mamaea&postLocation=)</code> `🚀 OpenMW` `night`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-11-khajiit-gives-away&postLocation=)</code> `🚀 OpenMW` `mannequinchallenge`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-30-the-road-most-travelled&postLocation=)</code> `🚀 OpenMW`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-26-imperial-pennant-and-masser&postLocation=)</code> `🚀 OpenMW` `moon`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-22-lord-gothren&postLocation=)</code> `🚀 OpenMW` `guard` `encounter`
