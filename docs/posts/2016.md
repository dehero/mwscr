...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-31-far-friends&postLocation=)</code> `🚀 OpenMW` `nofilter` `night` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` `📍 Holamayan` `🚀 OpenMW` `morrowind` `footage` `openmw` `elderscrolls`
...
`A1` `📍 Caldera` `🚀 OpenMW` `nofilter` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B1` `📍 Mzanchend` `🚀 OpenMW` `nofilter` `dwemer` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` `📍 Grazelands Region` `🚀 OpenMW` `nofilter` `road` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-24-double-winged-attack&postLocation=)</code> `🚀 OpenMW` `nofilter` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` `📍 Vivec, Palace of Vivec` `🚀 OpenMW` `mannequinchallenge` `morrowind` `footage` `openmw` `elderscrolls`
...
`B1` `📍 Gnisis` `🚀 OpenMW` `nofilter` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-20-a-boxy-nightstand&postLocation=)</code> `🚀 OpenMW` `nofilter` `morrowind` `elderscrolls` `screenshot` `openmw`
...
`E` `📍 Caldera` `🚀 OpenMW` `nofilter` `fort` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` `📍 Vivec` `🚀 OpenMW` `nofilter` `keyhole` `morrowind` `footage` `openmw` `elderscrolls`
...
`B1` `📍 Gnisis` `🚀 OpenMW` `nofilter` `temple` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-15-cloud-crowns-of-foyada-mamaea&postLocation=)</code> `🚀 OpenMW` `nofilter` `night` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B1` `📍 Pelagiad` `🚀 OpenMW` `nofilter` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` `📍 Seyda Neen` `🚀 OpenMW` `nofilter` `lighthouse` `night` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-11-khajiit-gives-away&postLocation=)</code> `🚀 OpenMW` `mannequinchallenge` `morrowind` `footage` `elderscrolls` `openmw`
...
`A2` `📍 Molag Mar` `🚀 OpenMW` `nofilter` `siltstrider` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` `📍 Manat's Farmhouse` `🚀 OpenMW` `nofilter` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B2` `📍 Nchuleft Ruin` `🚀 OpenMW` `nofilter` `dwemer` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` `📍 Molag Mar` `🚀 OpenMW` `nofilter` `candles` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` `📍 Balmora` `🚀 OpenMW` `nofilter` `morrowind` `footage` `openmw` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-03-st-delyn-vs-st-olms&postLocation=)</code> `🚀 OpenMW` `nofilter` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B1` `📍 Molag Mar` `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A1` `📍 Gnisis` `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-30-the-road-most-travelled&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-26-imperial-pennant-and-masser&postLocation=)</code> `🚀 OpenMW` `moon` `morrowind` `screenshot` `openmw`
...
`E` `📍 Dren Plantation` `🚀 OpenMW` `rain` `morrowind` `screenshot` `openmw`
...
`A2` `📍 Vivec` `🚀 OpenMW` `morrowind` `screenshot` `openmw`
...
`A1` `📍 Tel Branora` `🚀 OpenMW` `lantern` `lanterns` `morrowind` `screenshot` `openmw`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-22-lord-gothren&postLocation=)</code> `🚀 OpenMW` `guard` `encounter` `morrowind` `elderscrolls` `screenshot` `openmw`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-20-5-galom-daeus&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw`
...
`A2` `📍 Ald-ruhn, Manor District` `🚀 OpenMW` `morrowind` `screenshot` `openmw`
...
`B1` `📍 Molag Amur Region` `🚀 OpenMW` `lava` `morrowind` `screenshot` `openmw`
...
`B1` `📍 Seyda Neen` `🚀 OpenMW` `morrowind` `screenshot` `openmw`
