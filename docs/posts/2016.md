...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-31-far-friends&postLocation=)</code> `🚀 OpenMW` `nofilter` `night` `openmw`
...
`A1` `📍 Caldera` `🚀 OpenMW` `nofilter` `openmw`
...
`B1` `📍 Mzanchend` `🚀 OpenMW` `nofilter` `dwemer` `openmw`
...
`A2` `📍 Grazelands Region` `🚀 OpenMW` `nofilter` `road` `openmw`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-24-double-winged-attack&postLocation=)</code> `🚀 OpenMW` `nofilter` `openmw`
...
`A2` `📍 Vivec, Palace of Vivec` `🚀 OpenMW` `mannequinchallenge` `openmw`
...
`B1` `📍 Gnisis` `🚀 OpenMW` `nofilter` `openmw`
...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-20-a-boxy-nightstand&postLocation=)</code> `🚀 OpenMW` `nofilter` `openmw`
...
`E` `📍 Caldera` `🚀 OpenMW` `nofilter` `fort` `openmw`
...
`A2` `📍 Vivec` `🚀 OpenMW` `nofilter` `keyhole` `openmw`
...
`B1` `📍 Gnisis` `🚀 OpenMW` `nofilter` `temple` `openmw`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-15-cloud-crowns-of-foyada-mamaea&postLocation=)</code> `🚀 OpenMW` `nofilter` `night` `openmw`
...
`B1` `📍 Pelagiad` `🚀 OpenMW` `nofilter` `openmw`
...
`A2` `📍 Seyda Neen` `🚀 OpenMW` `nofilter` `lighthouse` `night` `openmw`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-11-khajiit-gives-away&postLocation=)</code> `🚀 OpenMW` `mannequinchallenge` `openmw`
...
`A2` `📍 Molag Mar` `🚀 OpenMW` `nofilter` `siltstrider` `openmw`
...
`A2` `📍 Manat's Farmhouse` `🚀 OpenMW` `nofilter` `openmw`
...
`B2` `📍 Nchuleft Ruin` `🚀 OpenMW` `nofilter` `dwemer` `openmw`
...
`A2` `📍 Molag Mar` `🚀 OpenMW` `nofilter` `candles` `openmw`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-03-st-delyn-vs-st-olms&postLocation=)</code> `🚀 OpenMW` `nofilter` `openmw`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-30-the-road-most-travelled&postLocation=)</code> `🚀 OpenMW` `openmw`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-26-imperial-pennant-and-masser&postLocation=)</code> `🚀 OpenMW` `moon` `openmw`
...
`E` `📍 Dren Plantation` `🚀 OpenMW` `rain` `openmw`
...
`A1` `📍 Tel Branora` `🚀 OpenMW` `lantern` `lanterns` `openmw`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-22-lord-gothren&postLocation=)</code> `🚀 OpenMW` `guard` `encounter` `openmw`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-20-5-galom-daeus&postLocation=)</code> `🚀 OpenMW` `openmw`
...
`A2` `📍 Ald-ruhn, Manor District` `🚀 OpenMW` `openmw`
...
`B1` `📍 Molag Amur Region` `🚀 OpenMW` `lava` `openmw`
