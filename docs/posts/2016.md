...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-31-far-friends&postLocation=)</code> `🚀 OpenMW` `nofilter` `night` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Holamayan` `🚀 OpenMW` `openmw` `morrowind` `footage` `elderscrolls`
...
`A1` `📍 Caldera` `🚀 OpenMW` `nofilter` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` `📍 Mzanchend` `🚀 OpenMW` `nofilter` `dwemer` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Grazelands Region` `🚀 OpenMW` `nofilter` `road` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-24-double-winged-attack&postLocation=)</code> `🚀 OpenMW` `nofilter` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Vivec, Palace of Vivec` `🚀 OpenMW` `mannequinchallenge` `openmw` `morrowind` `footage` `elderscrolls`
...
`B1` `📍 Gnisis` `🚀 OpenMW` `nofilter` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-20-a-boxy-nightstand&postLocation=)</code> `🚀 OpenMW` `nofilter` `openmw` `morrowind` `elderscrolls` `screenshot`
...
`E` `📍 Caldera` `🚀 OpenMW` `nofilter` `fort` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Vivec` `🚀 OpenMW` `nofilter` `keyhole` `openmw` `morrowind` `footage` `elderscrolls`
...
`B1` `📍 Gnisis` `🚀 OpenMW` `nofilter` `temple` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-15-cloud-crowns-of-foyada-mamaea&postLocation=)</code> `🚀 OpenMW` `nofilter` `night` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` `📍 Pelagiad` `🚀 OpenMW` `nofilter` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Seyda Neen` `🚀 OpenMW` `nofilter` `lighthouse` `night` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-11-khajiit-gives-away&postLocation=)</code> `🚀 OpenMW` `mannequinchallenge` `openmw` `morrowind` `footage` `elderscrolls`
...
`A2` `📍 Molag Mar` `🚀 OpenMW` `nofilter` `siltstrider` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Manat's Farmhouse` `🚀 OpenMW` `nofilter` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` `📍 Nchuleft Ruin` `🚀 OpenMW` `nofilter` `dwemer` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Molag Mar` `🚀 OpenMW` `nofilter` `candles` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Balmora` `🚀 OpenMW` `nofilter` `openmw` `morrowind` `footage` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-12-03-st-delyn-vs-st-olms&postLocation=)</code> `🚀 OpenMW` `nofilter` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` `📍 Molag Mar` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A1` `📍 Gnisis` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-30-the-road-most-travelled&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` `📍 Ashlands Region` `opennw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-26-imperial-pennant-and-masser&postLocation=)</code> `🚀 OpenMW` `moon` `openmw` `morrowind` `screenshot`
...
`E` `📍 Dren Plantation` `🚀 OpenMW` `rain` `openmw` `morrowind` `screenshot`
...
`A2` `📍 Vivec` `🚀 OpenMW` `openmw` `morrowind` `screenshot`
...
`A1` `📍 Tel Branora` `🚀 OpenMW` `lantern` `lanterns` `openmw` `morrowind` `screenshot`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-22-lord-gothren&postLocation=)</code> `🚀 OpenMW` `guard` `encounter` `openmw` `morrowind` `elderscrolls` `screenshot`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2016-11-20-5-galom-daeus&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot`
...
`A2` `📍 Ald-ruhn, Manor District` `🚀 OpenMW` `openmw` `morrowind` `screenshot`
...
`B1` `📍 Molag Amur Region` `🚀 OpenMW` `lava` `openmw` `morrowind` `screenshot`
...
`B1` `📍 Seyda Neen` `🚀 OpenMW` `openmw` `morrowind` `screenshot`
