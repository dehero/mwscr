...
`C` `📍 West Gash Region` `🚀 OpenMW` `openmw`
...
`A2` `📍 Gnisis` `🚀 OpenMW` `lanterns` `openmw`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-10-behind-a-barrel&postLocation=)</code> `🚀 OpenMW` `barrel` `lantern` `openmw`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-08-under-two-parasols&postLocation=)</code> `🚀 OpenMW` `giantmushrooms` `campfire` `openmw`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-07-skaal-storages&postLocation=)</code> `🚀 OpenMW` `🔗 Bloodmoon` `snow` `bloodmoon` `openmw`
...
`B2` `📍 Bthungthumz` `🚀 OpenMW` `towers` `openmw`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-05-red-candles&postLocation=)</code> `🚀 OpenMW` `candles` `openmw`
...
`E` `📍 Skaal Village` `🚀 OpenMW` `🔗 Bloodmoon` `sunset` `fir` `bloodmoon` `openmw`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-03-spinning-wheel&postLocation=)</code> `🚀 OpenMW` `🔗 Bloodmoon` `spinningwheel` `bloodmoon` `openmw`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-02-reed-view&postLocation=)</code> `🚀 OpenMW` `openmw`
