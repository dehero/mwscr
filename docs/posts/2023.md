...
`C` `📍 West Gash Region` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Gnisis` `🚀 OpenMW` `lanterns` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-10-behind-a-barrel&postLocation=)</code> `🚀 OpenMW` `barrel` `lantern` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-08-under-two-parasols&postLocation=)</code> `🚀 OpenMW` `giantmushrooms` `campfire` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-07-skaal-storages&postLocation=)</code> `🚀 OpenMW` `🔗 Bloodmoon` `snow` `bloodmoon` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` `📍 Bthungthumz` `🚀 OpenMW` `towers` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-05-red-candles&postLocation=)</code> `🚀 OpenMW` `candles` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`E` `📍 Skaal Village` `🚀 OpenMW` `🔗 Bloodmoon` `sunset` `fir` `bloodmoon` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-03-spinning-wheel&postLocation=)</code> `🚀 OpenMW` `🔗 Bloodmoon` `spinningwheel` `bloodmoon` `openmw` `morrowind` `screenshot` `elderscrolls`
...
| [`vk`](https://vk.com/mwscr?w=wall-138249959_1399) | 2023-08-03 |   452 |    34 |       893 |   3.81 |
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-02-reed-view&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
