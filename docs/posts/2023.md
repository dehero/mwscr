...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-08-under-two-parasols&postLocation=)</code> `🚀 OpenMW` `giantmushrooms` `campfire`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-05-red-candles&postLocation=)</code> `🚀 OpenMW` `candles`
