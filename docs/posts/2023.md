...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2023-08-10-behind-a-barrel)</code> `🚀 OpenMW` `barrel` `lantern`
