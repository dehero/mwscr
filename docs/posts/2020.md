...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-18-behind-the-wall)</code> `🚀 OpenMW` `tower` `mushroom`
