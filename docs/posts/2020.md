...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-11-07-mushroom-fields-forever&postLocation=)</code> `🚀 OpenMW` `mushroom` `openmw` `morrowind` `screenshot` `elderscrolls`
...
- `tg` <ins title="2020-11-07-20-17-50">popeKlementMerkwurdigVIII</ins> oh ye bitlz reference
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-11-03-gray-ruins&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot`
...
`B1` `📍 Grazelands Region` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` `📍 Sanni` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`C` `📍 Bthungthumz` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-29-red-passage&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-28-cave-of-suffering&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-27-misty-passage&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Sotha Sil, Outer Flooded Halls` `🚀 OpenMW` `🔗 Tribunal` `tribunal` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-24-tinaso-alan&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Vivec` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-22-clagius-clanler-outfitter&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-21-land-of-rain&postLocation=)</code> `🚀 OpenMW` `trees` `rain` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`C` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-20-longing-for-a-departed-hero&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-19-nix-hound&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-18-on-the-other-side&postLocation=)</code> `🚀 OpenMW` `🔗 Bloodmoon` `bloodmoon` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` `📍 Urshilaku Camp` `🚀 OpenMW` `camp` `yurt` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-16-leaving-the-barrow&postLocation=)</code> `🚀 OpenMW` `🔗 Bloodmoon` `bloodmoon` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-15-guard-of-lower-waistworks&postLocation=)</code> `🚀 OpenMW` `ordinator` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-14-random-visitor&postLocation=)</code> `🚀 OpenMW` `temple` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Palansour` `🚀 OpenMW` `boat` `door` `bridge` `boating` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` `📍 Suran` `🚀 OpenMW` `lights` `night` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-11-underneath-the-moss&postLocation=)</code> `🚀 OpenMW` `tree` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` `📍 Assurnabitashpi` `🚀 OpenMW` `daedric` `ruins` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-26-forgotten-urns&postLocation=)</code> `🚀 OpenMW` `urns` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-25-water-supply&postLocation=)</code> `🚀 OpenMW` `barrel` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Bitter Coast Region` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Sadrith Mora` `🚀 OpenMW` `rain` `openmw` `morrowind` `screenshot` `elderscrolls`
...
|                                                    | published  | views | likes | followers | rating |
|----------------------------------------------------|------------|------:|------:|----------:|-------:|
| [`ig`](https://instagram.com/p/CAiLuBoBYXG/)       | 2020-05-23 |       |   287 |           |        |
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-22-apothecary-door&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-21-deadly-attack&postLocation=)</code> `🚀 OpenMW` `skeleton` `shield` `sword` `openmw` `morrowind` `screenshot` `elderscrolls`
...
|                                                    | published  | views | likes | followers | rating |
|----------------------------------------------------|------------|------:|------:|----------:|-------:|
| [`ig`](https://instagram.com/p/CAdJpd6BEV0/)       | 2020-05-21 |       |   199 |           |        |
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-20-bridges&postLocation=)</code> `🚀 OpenMW` `bridge` `openmw` `morrowind` `screenshot` `elderscrolls`
...
|                                                    | published  | views | likes | followers | rating |
|----------------------------------------------------|------------|------:|------:|----------:|-------:|
| [`ig`](https://instagram.com/p/CAaiCnxBrhW/)       | 2020-05-20 |       |   271 |           |        |
...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-19-night-guard&postLocation=)</code> `🚀 OpenMW` `guard` `torch` `openmw` `morrowind` `screenshot` `elderscrolls`
...
|                                                    | published  | views | likes | followers | rating |
|----------------------------------------------------|------------|------:|------:|----------:|-------:|
| [`ig`](https://instagram.com/p/CAYUuMbBVee/)       | 2020-05-19 |       |   225 |           |        |
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-18-behind-the-wall&postLocation=)</code> `🚀 OpenMW` `tower` `mushroom` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-17-ama-nin&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` `📍 Tel Mora` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-15-brave-riekling&postLocation=)</code> `🚀 OpenMW` `🔗 Bloodmoon` `bloodmoon` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-14-inside-a-furnace&postLocation=)</code> `🚀 OpenMW` `forge` `blacksmith` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-13-isolated-shelter&postLocation=)</code> `🚀 OpenMW` `lantern` `yurt` `openmw` `morrowind` `screenshot` `elderscrolls`
