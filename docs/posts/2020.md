...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-21-land-of-rain&postLocation=)</code> `🚀 OpenMW` `trees` `rain`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-26-forgotten-urns&postLocation=)</code> `🚀 OpenMW` `urns`
