...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-11-07-mushroom-fields-forever&postLocation=)</code> `🚀 OpenMW` `mushroom` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-11-03-gray-ruins&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw`
...
`B1` `📍 Grazelands Region` `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B1` `📍 Sanni` `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`C` `📍 Bthungthumz` `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-29-red-passage&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-28-cave-of-suffering&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-27-misty-passage&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` `📍 Sotha Sil, Outer Flooded Halls` `🚀 OpenMW` `🔗 Tribunal` `morrowind` `tribunal` `screenshot` `openmw` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-24-tinaso-alan&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` `📍 Vivec` `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-22-clagius-clanler-outfitter&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-21-land-of-rain&postLocation=)</code> `🚀 OpenMW` `trees` `rain` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`C` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-20-longing-for-a-departed-hero&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-19-nix-hound&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-18-on-the-other-side&postLocation=)</code> `🚀 OpenMW` `🔗 Bloodmoon` `morrowind` `bloodmoon` `screenshot` `openmw` `elderscrolls`
...
`B2` `📍 Urshilaku Camp` `🚀 OpenMW` `camp` `yurt` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-16-leaving-the-barrow&postLocation=)</code> `🚀 OpenMW` `🔗 Bloodmoon` `morrowind` `bloodmoon` `screenshot` `openmw` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-15-guard-of-lower-waistworks&postLocation=)</code> `🚀 OpenMW` `ordinator` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-14-random-visitor&postLocation=)</code> `🚀 OpenMW` `temple` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` `📍 Palansour` `🚀 OpenMW` `boat` `door` `bridge` `boating` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B1` `📍 Suran` `🚀 OpenMW` `lights` `night` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-10-11-underneath-the-moss&postLocation=)</code> `🚀 OpenMW` `tree` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B1` `📍 Assurnabitashpi` `🚀 OpenMW` `daedric` `ruins` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-26-forgotten-urns&postLocation=)</code> `🚀 OpenMW` `urns` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-25-water-supply&postLocation=)</code> `🚀 OpenMW` `barrel` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` `📍 Bitter Coast Region` `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` `📍 Sadrith Mora` `🚀 OpenMW` `rain` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-22-apothecary-door&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-21-deadly-attack&postLocation=)</code> `🚀 OpenMW` `skeleton` `shield` `sword` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-20-bridges&postLocation=)</code> `🚀 OpenMW` `bridge` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-19-night-guard&postLocation=)</code> `🚀 OpenMW` `guard` `torch` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-18-behind-the-wall&postLocation=)</code> `🚀 OpenMW` `tower` `mushroom` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-17-ama-nin&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B2` `📍 Tel Mora` `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-15-brave-riekling&postLocation=)</code> `🚀 OpenMW` `🔗 Bloodmoon` `morrowind` `bloodmoon` `screenshot` `openmw` `elderscrolls`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-14-inside-a-furnace&postLocation=)</code> `🚀 OpenMW` `forge` `blacksmith` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2020-05-13-isolated-shelter&postLocation=)</code> `🚀 OpenMW` `lantern` `yurt` `morrowind` `screenshot` `openmw` `elderscrolls`
