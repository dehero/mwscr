...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-22-the-wind-is-getting-stronger&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` `📍 Skaal Village` `🚀 OpenMW` `🔗 Bloodmoon` `snow` `village` `fence` `bloodmoon` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-20-sunset-ridge&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-15-no-name-club&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-14-quiet-mooring&postLocation=)</code> `🚀 OpenMW` `boat` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-13-gray-distance&postLocation=)</code> `🚀 OpenMW` `gray` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-12-imperial-candelabrum&postLocation=)</code> `🚀 OpenMW` `candles` `candelabrum` `openmw` `candle` `morrowind` `screenshot` `elderscrolls`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-11-red-threat&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` `📍 Old Mournhold` `🚀 OpenMW` `🔗 Tribunal` `tribunal` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-09-yellow-mile&postLocation=)</code> `🚀 OpenMW` `prison` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-08-dead-road&postLocation=)</code> `🚀 OpenMW` `road` `rain` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-07-ancestral-web&postLocation=)</code> `🚀 OpenMW` `tomb` `skeleton` `webdesign` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-06-dwemer-telescope&postLocation=)</code> `🚀 OpenMW` `telescope` `observatory` `dwemer` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-05-saber-and-heart&postLocation=)</code> `🚀 OpenMW` `saber` `heart` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Balmora` `🚀 OpenMW` `rain` `river` `arch` `banner` `balmora` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-03-maiden-and-knight&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-10-02-dreamer&postLocation=)</code> `🚀 OpenMW` `sewers` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A1` `📍 Vivec` `🚀 OpenMW` `sun` `banner` `vivec` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-05-17-three-trees-by-the-road&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` `📍 Skaal Village` `🚀 OpenMW` `🔗 Bloodmoon` `bloodmoon` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A1` `📍 Urshilaku Camp` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Mzanchend` `🚀 OpenMW` `drawing` `dwemer` `towers` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-05-13-at-the-bridge&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-05-12-in-the-imperial-armory&postLocation=)</code> `🚀 OpenMW` `helmet` `sword` `candles` `openmw` `candle` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-05-11-misty-pairs&postLocation=)</code> `🚀 OpenMW` `giantmushrooms` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-05-10-at-the-corner-of-guard-tower&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-05-09-opposing-the-dusk&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-05-08-an-old-bridge&postLocation=)</code> `🚀 OpenMW` `drawing` `bridge` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` `📍 Mzanchend` `🚀 OpenMW` `dwemer` `towers` `lava` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-04-01-aboard&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-03-21-sorcerers-cosiness&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-03-19-an-old-bridge&postLocation=)</code> `🚀 OpenMW` `bridge` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-03-18-misty-pairs&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` `📍 Tel Fyr` `🚀 OpenMW` `telvanni` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` `📍 Mzahnch` `🚀 OpenMW` `dwemer` `towers` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-03-04-evening-road&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-03-01-guardians-of-the-cave&postLocation=)</code> `🚀 OpenMW` `netch` `cave` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-02-27-glassworkers-hall&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-02-26-mirror-coast&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-02-24-mehrunes-dagon-and-his-worshiper&postLocation=)</code> `🚀 OpenMW` `statue` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`C` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-02-23-three-hunters&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` `📍 Mournhold Temple` `🚀 OpenMW` `🔗 Tribunal` `tribunal` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-02-20-machine-hall&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` `📍 West Gash Region` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-02-18-daedric-exit&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`E` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-02-17-landscape-with-a-pipe&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-02-16-vevrana-aryon&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-02-15-telvanni-table&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-02-13-kaushtarari&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` `📍 Molag Mar, Temple` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` `📍 Nchuleftingth` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` `📍 Molag Mar, Canalworks` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` `📍 Caldera` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` `📍 Sadrith Mora, Wolverine Hall` `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-02-07-travel-to-nowhere&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-02-06-barilzar-and-his-satellite&postLocation=)</code> `🚀 OpenMW` `🔗 Tribunal` `tribunal` `openmw` `morrowind` `screenshot` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2019-02-05-welcome-back&postLocation=)</code> `🚀 OpenMW` `openmw` `morrowind` `screenshot` `elderscrolls`
