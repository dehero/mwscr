...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2022-07-14-blue-lit-basket&postLocation=)</code> `🚀 OpenMW` `basket` `candles` `morrowind` `screenshot` `openmw` `candle`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2022-07-08-squad&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`E` `📍 Sadrith Mora, Dirty Muriel's Cornerclub` `🚀 OpenMW` `stilllife` `orc` `candelabra` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`A2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2022-07-05-iron-enemy&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B1` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2022-07-02-niras-farys-priest&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
...
`B2` <code>📍 [Locate](https://github.com/dehero/mwscr/issues/new?labels=location&template=location.yml&title=2022-06-30-rivals&postLocation=)</code> `🚀 OpenMW` `morrowind` `screenshot` `openmw` `elderscrolls`
