...
import { getUploads, uploadFiles } from '../../../core/data-managers/uploads-manager.ts';
import { dataPatchToString, getDataPatchName, stringToDataPatch } from '../../../core/entities/data-patch.ts';
...
import type { DataPatchSaveParams } from '../DataPatchSaveDialog/DataPatchSaveDialog.tsx';
import { Toast, useToaster } from '../Toaster/Toaster.tsx';

const DataPatchPreviewDialog = lazy(() => import('../DataPatchPreviewDialog/DataPatchPreviewDialog.tsx'));
const DataPatchSaveDialog = lazy(() => import('../DataPatchSaveDialog/DataPatchSaveDialog.tsx'));
