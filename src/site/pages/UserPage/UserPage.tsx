...
import { postTypeDescriptors } from '../../../core/entities/post.ts';
import { postsManagerDescriptors, PostsManagerName } from '../../../core/entities/posts-manager.ts';
import { isPostsUsageEmpty } from '../../../core/entities/posts-usage.ts';
...
import { getPostsPageSearchParamsFromSelectionParams } from '../PostsPage/PostsPage.data.ts';
import type { UserPageData, UserPageParams } from './UserPage.data.ts';
import { queryUserPageData } from './UserPage.data.ts';
...
export const UserPage: SiteRoutePage<UserPageParams, UserPageData> = (props) => {
  ...
  useLocalPatch(() => {
    refetch();
    revalidate(queryUserPageData.key);
  });
            ...
            <Frame component="section" class={styles.posts}>
              <Show
                when={
                  ...
                  (data()?.lastExtraPostInfos && data()!.lastExtraPostInfos.length > 0) ||
