...
Предложенные работы пройдут автоматическую проверку и попадут в [черновики](https://mwscr.dehero.site/inbox/). После
...
Ваш запрос будет добавлен в [черновики](https://mwscr.dehero.site/inbox/) и останется там, дожидаясь подходящий
материал.
...
[Черновики](https://mwscr.dehero.site/inbox/). При возникновении вопросов пишите
[администратору](https://mwscr.dehero.site/users/dehero/) любым удобным способом.
...
Обработанные версии будут добавлены в [черновики](https://mwscr.dehero.site/inbox/) при следующем импорте файлов из
хранилища.
